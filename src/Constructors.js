      ...
      {driverInfo.map((driver, index) => (
        (index % 2 === 0) && (
          <ul key={driver.Constructors[0].name} className="teams">
            ...
            >
              <img src={process.env.PUBLIC_URL + './assets/' + `${driver.Constructors[0].constructorId}` + '.png'} alt="Logo" />
                    ...
                    .map(d => {
                      ...
                      return (
                        <div key={d.Driver.driverId}>
                          ...
                          <p>Age: {age}</p>
                          <img src={process.env.PUBLIC_URL + './assets/' + `${d.Driver.driverId}` + '.png'} alt={'Driver picture ' + `${d.Driver.driverId}`} />
